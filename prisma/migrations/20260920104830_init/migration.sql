-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'ADMIN_FINANCE', 'SUPER_ADMIN');

-- CreateEnum
CREATE TYPE "ProductType" AS ENUM ('SALE', 'REQUEST');

-- CreateEnum
CREATE TYPE "ProductState" AS ENUM ('NEUF', 'OCCASION_BON_ETAT', 'OCCASION_MOYEN');
...
CREATE TABLE "Product" (
    ...
    "priceCDF" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "quantity" INTEGER NOT NULL DEFAULT 1,
    "state" "ProductState" NOT NULL DEFAULT 'NEUF',
...
CREATE TABLE "Order" (
    ...
    "totalCDF" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE "Wallet" (
    ...
    "balanceCDF" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Reel_productId_key" ON "Reel"("productId");
